<template>
  <el-card style="padding: 10px;margin: 20px ;overflow: hidden;">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="proName" label="商品名" width="200" />
      <el-table-column prop="proPrice" label="单价" width="150" />
      <el-table-column prop="proNum" label="数量" width="150" />
      <el-table-column prop="proPay" label="实付款" width="200" />
      <el-table-column prop="proStatus" label="交易状态" width="200" />
<!--      <el-table-column  fixed="right" label="操作" align="center" width="150">-->
<!--        <template #default="scope">-->
<!--          <el-button v-if="scope.row.proStatus === '未支付'" plain type="danger" size="small" @click="handlePay(scope.row)">-->
<!--            立即付款-->
<!--          </el-button>-->
<!--        </template>-->
<!--      </el-table-column>-->
...
const submitForm = async (formEl: FormInstance | undefined) => {
  ...
  try {
    ...
    // 发送 POST 请求到后端 API
    const response = await request.post('/buyer/addUser', formData);
